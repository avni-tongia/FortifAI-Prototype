...
# ---------------------------------------------------
# Synthetic Full Account Profile Generator
# ---------------------------------------------------

account_profiles = []

for account_id in range(1, 21):  # simulate 20 accounts
    ...
    avg_session_length = random.uniform(30, 900)
    avg_form_fill_time = random.uniform(2, 15)
    click_pattern_abnormality = random.uniform(0, 1)
...
print("✅ Full behavioral account profiles generated.")
