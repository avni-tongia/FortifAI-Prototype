...
# Simulate synthetic transactions for each account
synthetic_transactions = []
for index, row in profile_df.iterrows():
    for _ in range(random.randint(10, 50)):  # Multiple transactions per account
        ...
        # Simulate some simple fraud logic
        fraud_label = 0
        if vpn_used == 'Yes' and account_age_days < 30 and cart_total > 2000:
            fraud_label = 1
...
print("✅ Standalone Phase 2 retrainer completed successfully.")
